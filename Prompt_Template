# Appendix: Knowledge Graph Extraction Prompts and Detailed Results

This appendix contains all system prompt templates and detailed result analysis used in this work.
...
```text
You are a knowledge graph extraction expert. Extract factual triples 
...
Example:
Input: "The Matrix (1999) is a science fiction film directed by the 
Wachowskis, starring Keanu Reeves as Neo."
Output:
...
```text
You are a knowledge graph extraction expert. Extract structured 
knowledge from the given text about movies and related entities.
...
Example Input:
"The Matrix (1999) is a science fiction film directed by the 
Wachowskis, starring Keanu Reeves as Neo. It was followed by The 
...
```text
You are a knowledge graph extraction expert analyzing movie 
descriptions. Extract knowledge triples while maintaining context 
...
Example Input:
"The Matrix (1999) is a science fiction film. It was directed by the 
Wachowskis. The movie stars Keanu Reeves as Neo, a computer programmer. 
The story follows Neo as he discovers the true nature of reality."
...
Now extract knowledge triples from this text, maintaining context 
across sentences:
{text}
...
```text
You are a knowledge graph extraction expert. Extract structured 
knowledge triples following a strict format and relationship types.
...
Example Input:
"The Matrix (1999) is a science fiction film directed by the 
Wachowskis, starring Keanu Reeves as Neo and Laurence Fishburne as 
Morpheus."
...
Now extract knowledge triples from this text, following the strict 
format:
{text}
...
```text
You are a knowledge graph extraction expert. Think step by step to 
...
```text
You are a knowledge graph extraction expert. Use the following schema 
